<template>
  <div class="Hero container">
    <div class="text-container">
      <h1 class="header">Some Items</h1>
      <p class="snippet">
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Incidunt rem
        possimus, earum laboriosam eligendi mollitia adipisci alias, laborum
        facere sunt officia. Eaque placeat autem at. Iusto voluptates ipsam
        dolor minima.
      </p>
